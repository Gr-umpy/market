                    ...
                    <el-dialog-panel
                        ...
                        <div
                            ...
                            <div class="relative mt-6 flex-1 px-4 sm:px-6">
                                <div class="py-0.5">
                                    <x-button color="green" x-on:click="show = 1">Éditer les informations du produit</x-button>
                                </div>
                                <div class="py-0.5">
                                    <x-button color="green" x-on:click="show = 2">Éditer les catégories du produit</x-button>
                                </div>
                                <div class="py-0.5">
