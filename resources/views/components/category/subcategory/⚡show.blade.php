...
new class extends Component
{
    ...
    public function render()
    {
        ...
        $this->showTable = $subcategories->isNotEmpty();

        return $this->view(['subcategories' => $subcategories]);
    }
    ...
    public function update()
    {
        ...
        Subcategory::find($this->editingId)->update(['name' => $this->editingName]);
        $this->cancelEdit();
    }
...
?>
<div>
    <h1 class="text-center">Sous-catégories :</h1>
            ...
            <tr class="bg-blue-400/10 even:bg-blue-400/20">
                ...
                <td class="py-1 border-b border-gray-400/50">
                    <div class="flex place-content-center">
                        <a href="#" wire:click.prevent='edit({{ $subcategory }})' class="text-green-600">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentcolor" class="size-5">
                                <path
                        ...
                        <a href="#" wire:confirm='êtes vous sûr de vouloir supprimer la catégorie {{ $subcategory->name }}?'
                            wire:click.prevent='delete({{ $subcategory }})' class="text-red-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentcolor" class="size-5">
                                <path fill-rule="evenodd"
